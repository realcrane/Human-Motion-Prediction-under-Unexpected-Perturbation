...
class NN_to_rod(nn.Module):

    def __init__(self):

        super(NN_to_rod, self).__init__()


        self.mlp = MLP_rod(input_dim = 12, output_dim = 1, hidden_size=[256, 128, 256])
...
class NN_to_rod_c(nn.Module):

    def __init__(self):

        super(NN_to_rod_c, self).__init__()


        self.mlp = MLP_rod(input_dim = 12, output_dim = 1, hidden_size=[128, 128])
